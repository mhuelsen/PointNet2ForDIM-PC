...
&emsp; <i style="background-color: #fff98c">Analysis of deep learning methods for the semantic segmentation of photogrammetric point clouds from aerial images</i><br>
